...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post participations_url, params: { participation: { content_id: @participation.content_id, is_public: @participation.is_public, is_recommend: @participation.is_recommend, user_name: @participation.user_name } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { content_id: @participation.content_id, is_public: @participation.is_public, is_recommend: @participation.is_recommend, user_name: @participation.user_name } }
